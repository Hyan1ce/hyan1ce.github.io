...
- 属于无监督学习的一种
- 将输入 $x$ 分为两部分：模型的输入 $x'$ ，模型的标签 $x''$ 
- 模型的输出为 $y$ ，优化目标是使 $y$ 尽可能贴近 $x''$

![image-20250919083207983](assets/image-20250919083207983.png)
...
- **BERT的训练**
  - 对输入中的某个字符进行掩码“如MASK字符/或替换为其他字符”
  - 下一句预测（用处小）/句序预测
...
![image-20251005213924142](assets/image-20251005213924142.png)
